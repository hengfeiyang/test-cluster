...
type cluster struct {
	Name     string `env:"ZINC_CLUSTER_NAME,default=zinc"`
	Hosts    string `env:"ZINC_CLUSTER_HOSTS"`
	NodeID   string `env:"ZINC_CLUSTER_NODE_ID"`
	NodePort string `env:"ZINC_CLUSTER_NODE_PORT,default=4090"`
}
